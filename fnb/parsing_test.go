...
const bulkLines = `
    ...
    * FNB :-) R1065.70 paid from cheq a/c..123456 @ Online Banking. Avail R15000. Ref.Apartment levy. 28Oct 15:40
    * FNB :-) R4784.09 paid from cheq a/c..123456 @ Eft. Avail R15000. Ref.Fnb H Loan 0000001. 28Oct 00:00
    ...
    * FNB :-) R141.64 reserved for purchase @ Paypal *dropboxirel from cheq a/c..123456 using card..1234
    * FNB :-) R585.11 reserved for purchase @ The magazine shop from cheq a/c..123456 using card..1234
    ...
    * FNB :-) R1305.00 paid from cheq a/c..123456 @ Online Banking. Avail R15000. Ref.Donation. 6Oct 15:30
...
func TestParsingLines(t *testing.T) {
	Convey("Testing parsing FNB lines", t, func() {
		...
		Convey("Check type counts", func() {
			So(len(expenses), ShouldEqual, len(lines))
